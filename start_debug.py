...
def setup_environment():
    ...
    try:
        ...
        # Report memory usage
        take_memory_snapshot("environment_setup")
...
def start_application():
    ...
    try:
        ...
        gc.collect()
        take_memory_snapshot("after_setup")
        ...
        try:
            ...
            take_memory_snapshot("after_pyqt_import")
        ...
        # Register exception hook for unhandled Qt exceptions
        ...
        try:
            ...
            take_memory_snapshot("after_mainwindow_import")
        except Exception as e:
        ...
        try:
            # Try with a smaller stack to detect stack issues
            window = MainWindow()
            try:
                # Add video processing functionality to the window
            ...
            take_memory_snapshot("after_mainwindow_create")
        ...
        try:
            ...
            take_memory_snapshot("after_mainwindow_show")
        except Exception as e:
        ...
        # Add a debug toolbar if possible
        try:
            ...
            stack_action.triggered.connect(print_thread_stacks)
            debug_toolbar.addAction(stack_action)

            # Add memory info action
            mem_action = QAction("Memory Info", window)
            mem_action.triggered.connect(lambda: take_memory_snapshot("user_requested"))
